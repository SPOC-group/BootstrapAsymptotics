"""
Functions that need to be reorganized to have a unifief interface for the state evolution.
    BayesOpt should not be an algorithm but a problem so that we can call e.g.

state_evolution(::BayesOpt, ::NoResampling, ::NoResampling)

or 

state_evolution(::BayesOpt, ::FullResampling, ::FullResampling)
"""
